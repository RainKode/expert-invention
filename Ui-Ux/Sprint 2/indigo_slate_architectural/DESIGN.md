...
This design system is built on the philosophy of **"The Digital Atrium."** In architecture, an atrium provides light, air, and a sense of monumental calm. For an HR SaaS, we move away from the cluttered "dashboard" look and toward a curated, editorial experience. 
...
*   **Instruction:** Forbid the use of horizontal divider lines (`<hr>`). 
